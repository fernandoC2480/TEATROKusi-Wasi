...
('Quipus Decorativos', 'Réplica artesanal de quipus incas, utilizados como sistema de registro. Pieza decorativa con significado histórico.', 65.00, 4, 25, TRUE),
('Flautas de Pan Andinas', 'Flautas de pan (zampoñas) tradicionales andinas. Instrumento musical auténtico con sonido cálido y envolvente.', 48.50, 2, 18, TRUE),
('Olla Cerámica Andina', 'Olla decorativa hecha a mano en cerámica con diseños andinos tradicionales. Perfecta para decoración o uso funcional.', 72.00, 4, 14, TRUE),
('Programa de Función Teatro Kusi-Wasi', 'Programa oficial impreso de las funciones del Teatro Kusi-Wasi. Recuerdo coleccionable de cada temporada.', 15.00, 3, 50, TRUE),
('Libro Historia del Teatro Andino', 'Libro ilustrado sobre la historia y evolución del teatro andino. Perfecto para conocer la tradición y cultura teatral.', 85.00, 3, 8, TRUE),
('Brazalete de Alpaca Andino', 'Brazalete elaborado en alpaca con diseños geométricos andinos. Joya representativa de la artesanía tradicional.', 42.00, 2, 22, TRUE),
('Mochila Tejida Tradicional', 'Mochila tejida a mano con lana de alpaca. Diseños auténticos y colores naturales. Práctica y artesanal.', 95.00, 2, 9, TRUE),
('Moneda Conmemorativa Teatro Kusi-Wasi', 'Moneda acuñada especial conmemorativa del teatro. Objeto coleccionable para fanáticos de la institución.', 25.00, 4, 35, TRUE),
('Poster Artístico Teatro Andino', 'Poster artístico de alta calidad con motivos del teatro andino. Marco perfecto para colecciones o decoración.', 20.00, 4, 40, TRUE),
('Chaleco de Lana Andino', 'Chaleco tejido en lana con patrones tradicionales andinos. Prenda cálida y elegante para cualquier ocasión.', 78.50, 1, 11, TRUE),
('Anillo de Plata Andino', 'Anillo de plata con grabados andinos. Joya fina que representa el arte y la tradición de los andes.', 88.00, 2, 16, TRUE),
('Bufanda de Alpaca Premium', 'Bufanda de alpaca de alta calidad con diseños andinos. Suave, cálida y elegante para el invierno.', 62.00, 1, 13, TRUE),
('Llavero Tejido Kusi-Wasi', 'Llavero tejido artesanalmente con los colores y diseños del teatro. Pequeño recuerdo perfecto de tu visita.', 12.50, 4, 60, TRUE),
('Prenda Tradicional Completa', 'Conjunto completo de vestuario andino tradicional. Incluye chuyo, faja y mochila. Perfecto para eventos culturales.', 220.00, 1, 5, TRUE),
('Libro Dramaturgía Andina', 'Colección de obras y scripts de teatro andino. Referencia importante para estudiosos y apasionados del arte teatral.', 95.00, 3, 7, TRUE);
