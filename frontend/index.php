...
<link rel="stylesheet" href="<?= $baseUrl ?>assets/css/carruselindex.css">
<link rel="stylesheet" href="<?= $baseUrl ?>assets/css/cuerpo_index.css">
...
<div class="contenedor">
    <div class="slide">
        <div class="item" style="background-image: url(<?= $baseUrl ?>assets/img/carrusel2.jpeg);">
            <div class="content">
        ...
        <div class="item" style="background-image: url(<?= $baseUrl ?>assets/img/carrusel5.jpg);">
            <div class="content">
                ...
                <a  href="<?= $baseUrl ?>pages/cartelera.php" style="text-decoration: none;">
                <button>Visitar</button>
                </a>
            </div>
        </div>
        <div class="item" style="background-image: url(<?= $baseUrl ?>assets/img/carrusel3.jpg);">
            <div class="content">
                ...
                <a  href="<?= $baseUrl ?>pages/tienda.php" style="text-decoration: none;">
                <button>Visitar Tienda</button>
                </a>
            </div>
        </div>
        <div class="item" style="background-image: url(<?= $baseUrl ?>assets/img/carrusel4.jpg);">
            <div class="content">
                <div class="name">Proyetos</div>
                <div class="des">Encuentra lo que ofrecemos y lo que se vendra muy pronto</div>
                <a  href="<?= $baseUrl ?>pages/proyectos.php" style="text-decoration: none;">
                <button>Visitar</button>
                </a>
            </div>
        </div>
        <div class="item" style="background-image: url(<?= $baseUrl ?>assets/img/carruselgif.gif);">
            <div class="content">
        ...
        <div class="item" style="background-image: url(<?= $baseUrl ?>assets/img/carrusel30.jpg);">
            <div class="content">
                <div class="name">Musica y mas</div>
                <div class="des">Puedes ser parte de nosotros en muscica danza y mucho mas...</div>
                <a  href="<?= $baseUrl ?>pages/proyectos/tallermusica.php" style="text-decoration: none;">
    ...
    <div class="button">
        <button class="prev"><img src="<?= $baseUrl ?>assets/img/izquierda.png" alt="Anterior"></button>
        <button class="next"><img src="<?= $baseUrl ?>assets/img/derecha.png" alt="Siguiente"></button>
    </div>
</div>
<!--FIN DE CARRUSEL-->
<!--INICIO DEL titulo  1-->
<div class="titulo1">
        <img src="<?= $baseUrl ?>assets/img/decoracion_index.png" alt="Flor decorativa" class="flor">
        <h1 class="texto-titulo">Nuestras Actuaciones</h1>
</div>
<!--cartas-->
<div class="actuaciones">
    <div class="actuacion">
        <img src="<?= $baseUrl ?>assets/img/carta1.jpg" alt="Actuación 1">
        <div class="info">
            ...
            <a href="<?= $baseUrl ?>pages/cartelera.php#eclesiasticos" class="t2">Saber más</a>
        </div>
    </div>

    <div class="actuacion">
        <img src="<?= $baseUrl ?>assets/img/carta2.jpg" alt="Actuación 2">
        <div class="info">
            ...
            <a href="<?= $baseUrl ?>pages/cartelera.php#ancestrales" class="t2">Saber más</a>
        </div>
    </div>

    <div class="actuacion">
        <img src="<?= $baseUrl ?>assets/img/cart3.jpg" alt="Actuación 3">
        <div class="info">
...
<!--titulo 2-->
<div class="titulo2">
        <img src="<?= $baseUrl ?>assets/img/decoracion_nosotros.png" alt="patrones" class="patron">
        <img src="<?= $baseUrl ?>assets/img/decoracion_nosotros.png" alt="patrones" class="patron1">
 ...
 <!--parte nosotros card-->
  ...
  <div class="cardN reveal-img">
    ...
    <img src="<?= $baseUrl ?>assets/img/img_nosotros.png" class="card-imgN img-reveal">

    <div class="card-overlayN">
      <div class="reveal-text">
        <img src="<?= $baseUrl ?>assets/img/nosotros_icon.png" class="iconN">
...
<div class="proyectosM">
  ...
  <div class="proy1 reveal-card left">
    <img src="<?= $baseUrl ?>assets/img/img_proyectos/card1f.jpg" class="img-anim">
    ...
    <div class="inf1 text-anim">
      ...
      <a href="<?= $baseUrl ?>pages/proyectos.php#nuevo">
  ...
  <div class="proy2 reveal-card right">
    <img src="<?= $baseUrl ?>assets/img/carta2.jpg" class="img-anim">
    ...
    <div class="inf2 text-anim">
      ...
      <a href="<?= $baseUrl ?>pages/proyectos.php#ms">
         <button class="t2">Saber más</button>
      </a>
    </div>
  </div>
...
<script src="<?= $baseUrl ?>assets/js/carruselindex.js"></script>
<script src="<?= $baseUrl ?>assets/js/nosotron_card.js"></script>
<script src="<?= $baseUrl ?>assets/js/proyectos_card.js"></script>
